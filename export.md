...
## src\resources\accounts\dto\create-account.dto.ts
...
## src\resources\accounts\dto\login.dto.ts
...
## src\resources\accounts\dto\register.dto.ts
...
## src\resources\accounts\dto\update-user.dto.ts
...
## src\resources\accounts\accounts.controller.ts
...
## src\resources\accounts\accounts.module.ts
...
## src\resources\accounts\accounts.service.ts
...
## src\resources\auth\dto\update-user.dto.ts
...
## src\resources\auth\guards\jwt-auth.guard.ts
...
import { JwtModule } from '@nestjs/jwt'; // Tambah ini
...
@Module({
  ...
  providers: [AuthService, JwtStrategy], // Tambah JwtStrategy di sini
...
## src\resources\auth\jwt.strategy.ts
...
export class JwtStrategy extends PassportStrategy(Strategy) {
  constructor() {
    super({
      ...
      secretOrKey: process.env.JWT_SECRET || 'rahasia_revobank_tommy',
    });
  }
...
## src\resources\transactions\dto\create-transaction.dto.ts
...
## src\resources\transactions\dto\update-user.dto.ts
...
## src\resources\transactions\transactions.controller.ts
...
## src\resources\transactions\transactions.module.ts
...
## src\resources\transactions\transactions.service.ts
...
## src\resources\users\users.repository.ts
...
DATABASE_URL="postgresql://postgres.taqydafheznyvaorcily:admintommy-revobank@aws-1-ap-southeast-1.pooler.supabase.com:6543/postgres?pgbouncer=true&pgprepare=false"
DIRECT_URL="postgresql://postgres.taqydafheznyvaorcily:admintommy-revobank@aws-1-ap-southeast-1.pooler.supabase.com:5432/postgres"
JWT_SECRET="RevoBank2026SecretKey"
```
...
```json
{
  "name": "-milestone-4-tommypoernomo",
  "version": "0.0.1",
  "lockfileVersion": 3,
  "requires": true,
  "packages": {
...
// datasource: {
//     url: process.env.DATABASE_URL,
//     // Di Prisma 7, jika butuh directUrl untuk migrasi, 
//     // biasanya diletakkan di sini atau langsung gunakan DIRECT_URL sebagai url.
//   },
// });
